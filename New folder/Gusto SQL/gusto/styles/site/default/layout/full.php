    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <div class="clearfix"></div>
                        <ul class="footer-links">
                            <?php $tips = $this->db->order_by('blog_id', 'desc')->limit('8')->get('blog')->result(); ?>
                            <?php if ($tips): ?>
        ...
        <div id="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p><?php echo config('copyright') ?>. Powered By <i class="fa fa-heart co-red"></i> <a href="https://khosinhvien.com/">Kho Sinh Viên</a>.</p>
                    </div>
                    <div class="col-md-8">
